                ...
                <main className="flex-grow flex flex-col justify-center max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="py-16">
                        <div className="text-center flex flex-col items-center">
                            ...
                            <h1 className="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Guardian for Business</h1>
                            <p className="mt-4 text-base text-gray-500 max-w-2xl mx-auto">COVID-19 one of the most difficult challenges we have had to face, but Guardian makes protecting your customers not only possible, but manageable. We&apos;re creating a page specifically to help you understand how Guardian can protect your staff and your customers.</p>
                            <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0 mx-auto">
                                ...
                                <form action="https://formspree.io/f/xpzkenkz" method="POST" className="mt-3 w-96 sm:flex">
